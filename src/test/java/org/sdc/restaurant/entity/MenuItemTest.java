...
public class MenuItemTest {
    ...
    @Test
    public void toCSV() {
        String target = "Hawaiian Pizza, All-time favourite toppings Hawaiian pizza in Tropical Hawaii style, https://s3-ap-southeast-1.amazonaws.com/interview.ampostech.com/backend/restaurant/menu1.jpg, 300.0, Italian Ham Pineapple, false";
